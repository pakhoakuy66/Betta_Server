...
export const ADMIN_LIFECYCLE_AUDIT_POLICY = Object.freeze({
  ...
  [AdminAuditAction.USER_SUSPENDED]: policy(AdminAuditTargetType.USER, [
    'beforeVersion',
    'afterVersion',
    'beforeState',
    'afterState',
  ...
  [AdminAuditAction.USER_UNSUSPENDED]: policy(AdminAuditTargetType.USER, [
    'beforeVersion',
    'afterVersion',
    'beforeState',
    'afterState',
  ...
  [AdminAuditAction.USER_BANNED]: policy(AdminAuditTargetType.USER, [
    'beforeVersion',
    'afterVersion',
    'beforeState',
    'afterState',
  ...
  [AdminAuditAction.USER_UNBANNED]: policy(AdminAuditTargetType.USER, [
    'beforeVersion',
    'afterVersion',
    'beforeState',
    'afterState',
  ...
  [AdminAuditAction.USER_DELETED]: policy(AdminAuditTargetType.USER, [
    'beforeVersion',
    'afterVersion',
    'beforeState',
    'afterState',
  ...
  [AdminAuditAction.USER_RESTORED]: policy(AdminAuditTargetType.USER, [
    'beforeVersion',
    'afterVersion',
    'beforeState',
    'afterState',
