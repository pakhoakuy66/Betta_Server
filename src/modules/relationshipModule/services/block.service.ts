...
export class BlockService {
  ...
  async blockUser(currentUserId: string, targetUserId: string) {
    ...
    try { await this.relationshipService.unfollowUser(currentUserId, targetUserId); } catch (e) {}
    try { await this.relationshipService.unfollowUser(targetUserId, currentUserId); } catch (e) {}
